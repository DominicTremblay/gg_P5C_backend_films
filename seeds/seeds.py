...
class FilmSeeder(Seeder):
    ...
    def run(self):
        ...
        utilisateurs = [
            {"nom": "Asterix", "courriel": "asterix@gmail.com",
                "mot_de_passe_hache": generate_password_hash("toutatis")},
            {"nom": "Obelix", "courriel": "obelix@gmail.com",
                "mot_de_passe_hache": generate_password_hash("toutatis")},
            {"nom": "Cetautomatix", "courriel": "cetautomatix@gmail.com",
                "mot_de_passe_hache": generate_password_hash("toutatis")},
            {"nom": "Abraracourcix", "courriel": "abraracourcix@gmail.com",
                "mot_de_passe_hache": generate_password_hash("toutatis")},
        ]
        ...
        for movie in movies:
            film = Film(
                titre=movie['titre'], genre=movie['genre'], annee_sortie=movie[
                    'annee_sortie'], image_url=movie['image_url'], description=movie['description']
            )
        ...
        for user in utilisateurs:
            utilisateur = Utilisateur(
                nom=user['nom'], courriel=user['courriel'], mot_passe_hache=user['mot_de_passe_hache']
            )
        ...
        for film in film_instances:
            for _ in range(3):
                ...
                print(f"Ajout commentaire: '{contenu}' par {
